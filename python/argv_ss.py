...
'''
Using commanf line input
AELZ_201: to use input fro keyboard, raw_input() function to be used
AELZ_202: see ex14 to write CLI session
AELZ_203: ex32: examples for cycle and lists (like array in C language)
